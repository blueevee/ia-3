...
# model = PPO('MlpPolicy', env, verbose=0, tensorboard_log="./models/PPO/logs/")


# # Create an evaluation callback to evaluate the model during training
# eval_callback = EvalCallback(env, best_model_save_path='./models/PPO/models/',
#                             log_path='./models/PPO/logs/', eval_freq=1000,
#                             deterministic=True, render=False)

# # Create a checkpoint callback to save the model at regular intervals
# checkpoint_callback = CheckpointCallback(save_freq=1000, save_path='./models/PPO/models/')
...
# model.save("./models/PPO/models/final_model")

# # # Close the environment
# del model 

# # VISUALIZAR O MODELO TREINADO
model = PPO.load("./models/PPO/models/final_model", env=env)
